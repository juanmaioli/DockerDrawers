...
CREATE TABLE `drawers_drawer`  (
  ...
  `drawer_description` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish2_ci NULL DEFAULT NULL,
...
CREATE TABLE `drawers_items`  (
  ...
  `item_description` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish2_ci NULL DEFAULT NULL,
